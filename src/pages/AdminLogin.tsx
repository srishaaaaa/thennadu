...
export default function AdminLogin() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#F9FAFB] px-4 py-8 font-sans text-[#111111] sm:px-6 lg:flex lg:items-center lg:justify-center">
      ...
      <div className="relative grid w-full max-w-5xl overflow-hidden rounded-[32px] border border-[#FDDBB4] bg-white shadow-[0_24px_80px_rgba(17,17,17,0.12)] lg:grid-cols-[0.9fr_1.1fr]">
        <div className="hidden flex-col justify-between bg-[#111111] p-10 text-white lg:flex">
          <div>
            <div className="mb-8 inline-flex items-center justify-center rounded-2xl bg-white border border-[#FDDBB4] p-2 shadow-xl"><img src={BRAND_LOGO} alt={`${BRAND_EN} logo`} className="h-12 w-auto max-w-[150px] rounded-xl object-contain" /></div>
            <p className="text-[11px] font-black uppercase tracking-[0.28em] text-[#F6C7A0]">{BRAND_SUBTITLE}</p>
          ...
          <div className="flex items-center gap-2 text-xs font-bold text-white/60"><ShieldCheck size={16} className="text-[#F6C7A0]" /> Secure admin workspace</div>
        </div>
        <div className="p-6 sm:p-10 lg:p-12">
        {/* Brand */}
        <div className="mb-8 flex flex-col items-center text-center lg:items-start lg:text-left">
          <div className="mb-5 inline-flex items-center justify-center rounded-2xl bg-white border border-[#FDDBB4] p-2 shadow-xl lg:hidden"><img src={BRAND_LOGO} alt={`${BRAND_EN} logo`} className="h-12 w-auto max-w-[150px] rounded-xl object-contain" /></div>
          ...
          <p className="mt-4 inline-flex items-center gap-2 rounded-full border border-[#FDDBB4] bg-[#FBFAF6] px-3 py-1.5 text-[11px] font-black uppercase tracking-wider text-[#E87020]">
            <ShieldCheck size={13} />
        ...
        <form onSubmit={handleSubmit} noValidate className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full rounded-2xl border-2 border-[#FDDBB4] bg-[#FBFAF6] px-4 py-3.5 text-sm font-semibold outline-none transition-colors placeholder:text-[#AAA69C] focus:border-[#E87020] focus:bg-white"
              value={portalId}
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full rounded-2xl border-2 border-[#FDDBB4] bg-[#FBFAF6] px-4 py-3.5 pr-12 text-sm font-semibold outline-none transition-colors placeholder:text-[#AAA69C] focus:border-[#E87020] focus:bg-white"
                value={password}
          ...
          <button
            type="submit"
            disabled={loading}
            className="group flex w-full items-center justify-center gap-2 rounded-2xl bg-[#E87020] py-3.5 font-black text-white shadow-lg shadow-[#E87020]/20 transition-colors hover:bg-[#C85C10] disabled:opacity-60"
          >
            {loading ? (
              <>
